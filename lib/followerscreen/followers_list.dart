...
class FollowersListScreen extends StatefulWidget {
  ...
  FollowersListScreen({required this.number, super.key, required this.id, this.isUnregisterUser = false});
...
class _FollowersListState extends State<FollowersListScreen> {
  ...
  void initState() {
    ...
    print("number ==> ${widget.isUnregisterUser}");

    provider = Provider.of<FollowersController>(context, listen: false);
    Future.microtask(() => context.read<FollowersController>().getFollowers(widget.number));
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  Get.to(() => MutualFollowersList(
                                      number: widget.number, id: widget.id, isUnregisterUser: widget.isUnregisterUser));
                                },
                                child: Text(
                                  'Mutual'.tr,
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              if (index < provider.followerListModel.data!.length) {
                                var itemData = provider.followerListModel.data![index];
