...
class _VoteSheetState extends State<ReviewVoteSheet> {
  ...
  getData() async {
    ...
    reviewVoteModel = await Provider.of<UserViewModel>(context, listen: false).reviewVoteList(widget.id, widget.isLike);
    setState(() {
      isLoading = false;
    });
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  isLoading
                      ...
                      : reviewVoteModel.data != null && reviewVoteModel.data!.isEmpty
                          ? SizedBox(
                              height: Get.height * 0.4,
                              width: Get.width,
                              child: const Center(
